      ...
      <T title="Reports | Seller • Multivendor MarketPlace">
        <div className="mt-1">
          <Paper elevation={1} className={this.props.classes.reportTypesRoot}>
            <div ref={el => Monthly.printComponent = el} className="m-30 p-30">
                  ...
                  <tr>
                    ...
                    <td colSpan="9">
                      <label className="mt-bs-2 pr-bs-5 float-right label-15">
                        <strong>MONTHLY PRODUCT REPORTS</strong>
                      </label>
                    </td>
                  </tr>
                  <tr>
              ...
              <table className="table-bs table-sm mb-bs-4 table-report">
                ...
                <tbody>
                  {
                    this.props.monthly.length ? this.props.monthly.map((r, i) => (
            ...
            <ReactToPrint
              ...
              content={() => Monthly.printComponent}
            />
          </Paper>
        </div>
      </T>
...
export default connect(mapStateToProps)(withStyles(styles)(Monthly));
